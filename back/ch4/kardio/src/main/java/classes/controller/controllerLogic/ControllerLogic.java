...
public class ControllerLogic {
    ...
    public EUser getUserData(String userDataJSON){
        ...
        try {
            ...
            System.out.println("HEREEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEE => " + euser.role + " " + euser.login + " " + euser.password + " " + euser.fullName + " " + euser.registrationDate + " " + euser.deletionDate + " " + euser.status + " " + euser.id);
        }
        catch (Exception ex) {
            System.out.println("ERROR in Controller.userCheckData: " + ex);
        }

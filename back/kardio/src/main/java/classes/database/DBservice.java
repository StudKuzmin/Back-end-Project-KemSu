...
public class DBservice {
    ...
    public List<Object> select(String entity) throws Exception{
        try {
            String query = entity + ".findAll";

            userTransaction.begin();
            entityManager.joinTransaction();

            List<Object> userList = entityManager.createNamedQuery(query).getResultList();
            userTransaction.commit();
